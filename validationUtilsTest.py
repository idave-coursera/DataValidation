...
from validationUtils import compareDFs
...
class ValidationUtilsTest(unittest.TestCase):
    ...
    def test_dataframes_creation(self):
        ...
        eds_data = [
            (2, "B", ["val_2b", "y"], (20, "sub2"), {"k2": 2},"1", "eds_val_2"),
        ...
        df_edw = self.spark.createDataFrame(edw_data, schema=edw_schema)
        df_eds = self.spark.createDataFrame(eds_data, schema=eds_schema)

        compareDFs(df_edw, df_eds)
